...
void MainWindow::on_schuifdeurKnop_clicked(){  
    if(door.at(2)->isDeurOpen()){
        door.at(2)->sluit();
        door.at(2)->getSlot()->vergrendel();
    }
    else{
        door.at(2)->getSlot()->ontgrendel(ui->lineEditS->text().toStdString());
...
void MainWindow::on_deur_1_clicked(){
    if(door.at(0)->isDeurOpen()){
        door.at(0)->sluit();
        door.at(0)->getSlot()->vergrendel();
    }
    else{
        door.at(0)->getSlot()->ontgrendel(ui->lineEditD1->text().toStdString());
...
void MainWindow::on_deur_2_clicked(){
    if(door.at(1)->isDeurOpen()){
        door.at(1)->sluit();
        door.at(1)->getSlot()->vergrendel();
    }
    else{
        door.at(1)->getSlot()->ontgrendel(ui->lineEditD2->text().toStdString());
